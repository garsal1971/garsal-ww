...
# --- 1. Cerca e clicca una card con badge arancione (prova N varianti) ---
        ...
        step("1779978240147.png", "Regala a un amico")

        # --- 3. Clicca sulla riga "garsal1971" ---
        step("1779978264226.png", "garsal1971 selezionato")

        # --- 4. Clicca "Seleziona" ---
        step("1779978291419.png", "Seleziona")

        # --- 5. Clicca "Invia" ---
        step("1779978317852.png", "Invia")

        # --- 6. Clicca "Inviane un'altra" -> torna alla collezione ---
        step("1779983041875.png", "Inviane un altra")
